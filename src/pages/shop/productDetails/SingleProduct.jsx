      ...
      <section className='section__container bg-gradient-to-r mt-8' dir='rtl'>
        <div className='flex flex-col items-center md:flex-row gap-8'>
          ...
          <div className='md:w-1/2 w-full relative'>
            {hasRealDiscount && (
              <div className="absolute top-3 left-3 bg-[#eb7eab] text-white text-xs font-bold px-2 py-1 rounded-full z-10">
              ...
              <>
                ...
                {singleProduct.image.length > 1 && (
                  <>
                    <button
                      onClick={prevImage}
                      className='absolute left-0 top-1/2 -translate-y-1/2 bg-white text-[color:#eb7eab] border border-[color:#eb7eab] p-2 rounded-full hover:bg-gray-50 shadow'
                    ...
                    <button
                      onClick={nextImage}
                      className='absolute right-0 top-1/2 -translate-y-1/2 bg-white text-[color:#eb7eab] border border-[color:#eb7eab] p-2 rounded-full hover:bg-gray-50 shadow'
                    ...
                    {singleProduct.image.map((img, idx) => (
                      <button
                        ...
                        className={`relative rounded-md overflow-hidden border ${
                          currentImageIndex === idx ? 'border-[color:#eb7eab]' : 'border-gray-200'
                        } hover:border-[color:#eb7eab]`}
          ...
          <div className='md:w-1/2 w-full'>
            ...
            <div className="mb-6 flex flex-col items-center text-center">
              ...
              <div className="inline-flex items-center gap-4 bg-gray-10 rounded-lg p-3 shadow-sm">
                <button
                  type="button"
                  onClick={decreaseQty}
                  className="w-12 h-12 flex items-center justify-center rounded-md bg-white text-[color:#eb7eab] border border-[color:#eb7eab] text-xl font-bold hover:bg-gray-50"
            ...
            <button
              ...
              className={`mt-6 px-6 py-3 rounded-md transition-all duration-200 relative overflow-hidden
                bg-[#eb7eab] text-white border border-[#eb7eab] hover:bg-[#eb7eab]
